...
class ReclamationFaccController extends AbstractController
{
     ...
     */
    public function new(Request $request, $id ,\Swift_Mailer $mailer ,  PublisherInterface $publisher) : Response
    {
    ...
    /**
     * @Route("/{id}/deletereclamationFacc", name="reclamation_facc_delete", methods={"DELETE"})
     */
     ...
     */
    public function lister(ReclamationFaccRepository $reclamationRepository)
    {
        $reclamations = $reclamationRepository->findByUser(1);
