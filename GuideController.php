...
class GuideController extends AbstractController
{
     ...
     */
    public function frontGuides(GuideRepository $guideRepository , PaginatorInterface $paginator , Request $request): Response
    {
        $donnees=$this->getDoctrine()->getManager()->getRepository(Guide::class)->findAll();
    ...
    /**
     * @Route("/guidesstat", name="guidesstat", methods={"GET"})
     */
    public function statistiqueAction(){
        $pieChart = new PieChart();
        $em= $this->getDoctrine()->getManager();
        $query = $em->createQuery('SELECT o  ,UPPER(e.nom) as nom ,COUNT(o.id) as num FROM App\Entity\Vendeur o
        join App\Entity\Guide e WITH e.id=o.guide GROUP BY o.guide');
        ...
        $pieChart->getOptions()->setTitle('Nombre Des Vendeurs par rapport à Chaque Guides!');
        ...
        return $this->render('guide/guidesstat.html.twig', array('piechart' => $pieChart));
    }
